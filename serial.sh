...
python importw.py 500000 1 > results_lab/50k/pg.txt
sleep 60
python importw.py 500000 2 > results_lab/50k/influx.txt
sleep 60
python importw.py 500000 3 > results_lab/50k/cassandra.txt
sleep 60
python importw.py 500000 4 > results_lab/50k/mongo.txt
